                    ...
                    <div class="grid gap-6 lg:grid-cols-2 lg:gap-8">
                            ...
                            <div class="relative flex items-center gap-6 lg:items-end">
                                <div id="docs-card-content" class="flex items-start gap-6 lg:flex-col">
                                    ...
                                    <div class="pt-3 sm:pt-5 lg:pt-0">
                                        <h2 class="text-xl font-semibold text-black dark:text-white">Ideal: J. Moraes
                                        </h2>

                                        <p class="mt-4 text-sm/relaxed">
                                            Por trás de toda grande conquista humana existe uma equipe. Essa é uma
                                            iniciativa, em prol do progresso da humanidade, por meio do poder do
                                            software. Nossa missão é ajudar você a revelar o potencial de todas as
                                            equipes.
                                        </p>
                                    </div>
                                </div>
                        ...
                        <a href="https://laracasts.com"
                            ...
                            <div class="pt-3 sm:pt-5">
                                <h2 class="text-xl font-semibold text-black dark:text-white">Ferramentas</h2>

                                <p class="mt-4 text-sm/relaxed">
                                    Este projeto esta utilizando entre outras ferramentas, principalmente Laravel, PHP,
                                    and JavaScript.
                                    A idéia aqui não é ser autêntico, mas estremamente funcional. “Quem caminha sozinho
